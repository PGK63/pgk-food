# iOS Real Device Scenarios (2026-02-28 Regression)
...
`[SCENARIO_ID] [PASS/FAIL] [device/os] [timestamp] [artifact path] [defect id or '-']`

Example:

`SCN-02 PASS iPhone 15 / iOS 18.2 2026-02-28T14:25:00+03:00 artifacts/ios/scn-02-pass.mov -`
